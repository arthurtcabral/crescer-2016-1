...
$(function() {
  ...
  console.log(goldSaintsAdaptados);
...
$('button[name=addGolpe]').click(function(){
  ...
  $frmNovoCavaleiro.submit(function(e) {
    ...
    var tipoSanguineo = $('slTipoSanguineo').val();
    var urlImagem = $('#txtUrlImagem').val();
    var dataNascimento = $('#dateDataNascimento').val();
    var alturaCm = $('#numAlturaCm').val();
    var pesoLb = $('#numPesoLb').val();
